...
export default function Contact() {
    ...
    const introText =
        contact?.intro ||
        "Molim vas popunite formular u ovom delu stranice kako biste me kontaktirali ili pozovite između 9:00 i 20:00, od ponedeljka do petka.";
    ...
    const phoneHref = `tel:${String(phoneValue).replace(/\s+/g, "")}`;
    ...
    const hasInstagram = Boolean(instagramHandle) && Boolean(instagramUrl);
    const hasAnyInfo = hasAddress || hasEmail || hasPhone || hasInstagram;
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4">
                {/* Naslov */}
                <div
                    className={`mb-12 md:mb-20 text-center md:text-left ${visible ? "animate__animated animate__fadeInUp animate__slow" : "opacity-0"
                        }`}
                >
                ...
                {/* Info + forma */}
                <div
                    className={`grid gap-10 md:grid-cols-2 md:items-center lg:items-center ${visible
                        ? "animate__animated animate__fadeInUp animate__faster animate__slow"
                        : "opacity-0"
                        }`}
                >
                    {/* LEVA STRANA – tekst + info lista */}
                    <div className="md:pr-2 flex flex-col">
                        ...
                        <ul className="space-y-8 text-sm md:text-[15px]">
                            {!hasAnyInfo && (
                                <li className="text-text-base/70 italic">
                                    (Kontakt informacije nisu unete u CMS-u.)
                                </li>
                            )}
                            ...
                            {hasAddress && (
                                <li className="flex items-center gap-4 group cursor-pointer transition-all">
                                    <span className="inline-flex items-center transition-transform duration-300 group-hover:scale-125 group-hover:-rotate-6">
                                        <img src="/img/svg/location.svg" alt="location" className="h-5 w-5" loading="lazy" />
                                    </span>
                            ...
                            {hasEmail && (
                                <li className="flex items-center gap-4 group cursor-pointer transition-all">
                                    <span className="inline-flex items-center transition-transform duration-300 group-hover:scale-125 group-hover:-rotate-6">
                                        <img src="/img/svg/email.svg" alt="email" className="h-5 w-5" loading="lazy" />
                                    </span>
                                    <div className="flex items-center gap-10 min-h-[24px]">
                                        <span className="font-semibold font-[Poppins] text-text-heading min-w-[90px] group-hover:text-primary transition-colors duration-300">
                                            Email:
                                        ...
                                        >
                                            <span className="relative z-10">{emailValue}</span>
                            ...
                            {hasPhone && (
                                <li className="flex items-center gap-4 group cursor-pointer transition-all">
                                    <span className="inline-flex items-center transition-transform duration-300 group-hover:scale-125 group-hover:-rotate-6">
                                        <img src="/img/svg/phone.svg" alt="phone" className="h-5 w-5" loading="lazy" />
                                    </span>
                                    <div className="flex items-center gap-10 min-h-[24px]">
                                        <span className="font-semibold font-[Poppins] text-text-heading min-w-[90px] group-hover:text-primary transition-colors duration-300">
                                            Telefon:
                                        ...
                                        <a
                                            ...
                                            className="text-text-base hover:text-primary group-hover:text-primary transition-colors duration-300 relative"
                                        >
                                            <span className="relative z-10">{phoneValue}</span>
                                            <span className="absolute left-0 right-0 bottom-0 h-[2px] bg-primary scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                                        </a>
                                    </div>
                                </li>
                            ...
                            {hasInstagram && (
                                <li className="flex items-center gap-4 group cursor-pointer transition-all">
                                    <span className="inline-flex items-center transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12">
                                        <img src="/img/svg/social/instagram.svg" alt="instagram" className="h-5 w-5" loading="lazy" />
                                    </span>
                                    <div className="flex items-center gap-10 min-h-[24px]">
                                        <span className="font-semibold font-[Poppins] text-text-heading min-w-[90px] group-hover:text-primary transition-colors duration-300">
                                            Instagram:
                                        ...
                                        <a
                                            ...
                                            className="text-text-base hover:text-primary group-hover:text-primary transition-colors duration-300 relative"
                                        >
                                            <span className="relative z-10">{instagramHandle}</span>
